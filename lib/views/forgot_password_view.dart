...
import 'package:second_tutorial/utilities/dialogs/password_reset_email_sent_dialog.dart';
        ...
        if (state is AuthStateForgotPassword) {
          ...
          if (state.exception != null) {
            ...
            await showErrorDialog(context,
                "Your request could not be processed. Please make sure that you are a registered user!");
          }
        }
      },
      child: Scaffold(
